    ...
    def _build_messages(
        ...
        human_message = HumanMessage(
            content=(
                ...
                "Regra de desempate: se a evidencia mostrar IA como feature "
                "ou modulo dentro de um produto mais amplo, escolha "
                "ai_enabled, nao ai_native. Reserve ai_native para empresas "
                "cuja oferta central e construir, hospedar, treinar, servir "
                "ou gerar com modelos de IA.\n\n"
